...
f=open("C:\Users\Abhishek De\Documents\GitHub\Mantle\cache.txt","r")
newf=open("C:\Users\Abhishek De\Documents\GitHub\Mantle\cache.txt","w")
lines=f.readlines()
...
newf.writelines(city+","+weather_temp[0][0]+","+weather_condition[0]+"\n")
for line in lines:
    newf.write(line)
